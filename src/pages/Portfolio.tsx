...
const Portfolio: React.FC<PortfolioProps> = ({ text }) => {
    return (
        <section className="text-black px-4 max-w-6xl mx-auto mt-32 mb-28">
            {/* Título animado */}
            <motion.h2
                initial={{ opacity: 0, y: -20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6 }}
                className="text-4xl font-extrabold text-center text-cyan-400 mb-4 tracking-tight"
            >
            ...
            <motion.p
                ...
                className="text-center text-cyan-300 mb-12 text-lg"
            >
            ...
            >
                <div className="bg-[#0f1f2d]  border border-cyan-300 rounded-2xl shadow-2xl p-8 hover:shadow-[0_0_30px_rgba(0,200,255,0.2)] transition-all duration-300 flex flex-col w-full max-w-4xl">

                    <div className="w-full h-[320px] bg-[#0f1f2d] rounded-xl overflow-hidden mb-6">
                        <motion.img
                            whileHover={{ scale: 1.05 }}
                            transition={{ duration: 0.3 }}
                            src={swapfyLogo}
                            alt="Swapfy"
                            className="object-contain w-full h-full p-8 rounded-xl
             ...
             transition-all duration-500"
                    ...
                    <h3 className="text-cyan-300 text-3xl font-extrabold mb-2 tracking-wide">
                    ...
                    <div className="flex justify-end gap-6 mt-6 text-cyan-400 text-2xl">
                        <a
